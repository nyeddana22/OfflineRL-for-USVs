...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_3fB3H().pack(_x.battery, _x.current_left, _x.current_right, _x.rc, _x.rc_throttle, _x.rc_rotation, _x.rc_enable))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.battery, _x.current_left, _x.current_right, _x.rc, _x.rc_throttle, _x.rc_rotation, _x.rc_enable,) = _get_struct_3fB3H().unpack(str[start:end])
      return self
...
def _get_struct_3I():
    ...
    return _struct_3I
_struct_3fB3H = None
def _get_struct_3fB3H():
    global _struct_3fB3H
    if _struct_3fB3H is None:
        _struct_3fB3H = struct.Struct("<3fB3H")
    return _struct_3fB3H
